<div align ="justify">
  ...
  <div align="center">
    <img src="https://user-images.githubusercontent.com/80075307/224563322-f80c86cc-1334-4360-8a70-17477d114c82.jpeg" width="45%" alt="JavaScript Logo">
    <img src="https://user-images.githubusercontent.com/80075307/224563502-c80c158e-b226-47f7-9ab6-be0f32ba399f.png" width="45%" alt="Web Development Tools">
  </div>
...
### 1) NODE.JS
  ...
  <div align="center">
  <img src= "https://github.com/DsBrito/Web_development/assets/80075307/11a6eae0-5090-4e7d-984f-3760159a6f67"  width="70%"  alt ="Node.js">
  </div>
...
HTTP requests are messages sent by the client to initiate an action on the server.
  ...
  <div align="center">
    <img src = "IMAGES/node/http-request.png" alt="HTTP Request" width=60%>
    <img src = "IMAGES/node/localhost.png" alt="Localhost" width=55%>
  </div>
...
Need use a command for create and define a package.json: `npm init`
  ...
  <div align="center">
    <img src ="IMAGES/node/createJSON.png" alt="Create JSON" width=65%>
    <br /><br />
  </div>
...
For install dependencies (ex: axios): `npm i --save axios`
  ...
  <div align="center">
    <img src = "IMAGES/node/dependenciesJSON.png" alt="Dependencies JSON" width=75%>
  </div>
...
### 2) ES NEXT
  ...
  <div align="center">
    <img src = "IMAGES/esnext/ESNEXT.webp" alt="ESNext JavaScript" width=20%>
  </div>
...
#### VsCode Extension
  ...
  <div align="center">
    <img src="https://user-images.githubusercontent.com/80075307/224575584-0838e575-9e1f-4744-9b97-afe79be816ed.png" alt="VsCode Extension" width="30%">
  </div>
...
Need to press Ctrl + Alt + N to run a .js program with Node or Ctrl + Alt + M to stop a .js program.
  ...
  <div align="center">
    <img src="https://user-images.githubusercontent.com/80075307/224572016-e8110675-c669-4c92-b9a0-256f3bf13802.png" alt="Run JS Program" width="50%">
    <img src="https://user-images.githubusercontent.com/80075307/224572118-bb6df855-f6d0-4f8e-9e18-94530ea8d843.png" alt="Stop JS Program" width="50%">
  </div>
...
Webpack is a popular open-source module bundler for JavaScript applications. It is used in web development to bundle together JavaScript files, along with their dependencies such as CSS, images, and fonts, into a single bundle or multiple bundles. This bundling process helps optimize the performance of web applications by reducing the number of HTTP requests needed to load a page and by efficiently managing the dependencies between different modules.
Webpack operates on the concept of a dependency graph, where each module in the application is treated as a node, and the dependencies between these modules are represented as edges in the graph. When you run webpack, it starts from an entry point (usually a JavaScript file) and recursively builds a dependency graph by analyzing import and require statements in your code. It then processes each module and its dependencies, applying transformations like transpilation (using tools like Babel) and optimization (such as minification and code splitting), before finally outputting one or more bundles that can be included in a web page.

Webpack is highly configurable and extensible, allowing developers to customize its behavior through configuration files (usually named webpack.config.js) and by using plugins and loaders. Plugins can be used to perform additional tasks like generating HTML files, extracting CSS into separate files, or optimizing assets, while loaders enable webpack to process different types of files beyond JavaScript, such as CSS, images, and JSON.

#### Extra Links

Overall, webpack has become an essential tool in modern web development workflows, particularly for projects built with frameworks like React, Vue.js, and Angular, where modularization and optimization of code assets are crucial for performance and maintainability.
Some links with guides about Gulp, Babel, TypeScript, SASS:

- Webpack Documentation [here](https://webpack.js.org/concepts/)
- Sass Documentation [here](https://sass-lang.com/documentation/)
